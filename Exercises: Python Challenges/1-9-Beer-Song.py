...
class BeerSong:
    ...
    def verse(cls, beers):
        match beers:
            ...
            case 2:
                return (
                    f"{beers} bottles of beer on the wall, {beers} bottles " + 
                     "of beer.\n"
                    f"Take one down and pass it around, {beers - 1} " + 
    ...
    def verses(cls, start, end):
        result = []
        for beers in range(start, end-1, -1):
            result.append(cls.verse(beers))
        return '\n'.join(result)
